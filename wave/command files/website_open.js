...
export const webopener = {
    ...
    'can i invest in property in your home': () => {
        try {
            speak("yes you can, showing you some results ")
            window.open("https://neom.com");
        }
    ...
    'can i invest in property in new home': () => {
        try {
            speak("yes you can, showing you some results ")
            window.open("https://neom.com");
        }
    ...
    'can i invest in property in niyam': () => {
        try {
            speak("yes you can, showing you some results ")
            window.open("https://neom.com");
        }
    ...
    'why is it attractive to invest in your home': () => {
        try {
            speak("Because its too good")
        }
        catch (error) {
    ...
    'why is it attractive to invest in new': () => {
        try {
            speak("Because its too good")
        }
        catch (error) {
    ...
    'why is it attractive to invest in niyam': () => {
        try {
            speak("Because its too good")
        }
        catch (error) {
    ...
    'why is it attractive to invest in new home': () => {
        try {
            speak("Because its too good")
        }
        catch (error) {
