        ...
        addCommands: function ( e ) {
            ...
            for ( var o in x(), e )
                if ( e.hasOwnProperty( o ) )
                    if ( "function" == typeof ( n = r[e[o]] || e[o] ) ) R( ( t = ( t = o ).replace( w, "\\$&" ).replace( h, "(?:$1)?" ).replace( b, function ( e, n ) {
                        return n ? e : "([^\\s]+)"
...
import { webopener } from '../command files/website_open.js';
import { calculate } from "../command files/calculation.js"
import { weather_fact } from "../command files/fact&weather.js"
import { conversation } from "../command files/conversation.js"
import { user_said } from '../main/functions.js'
import { control } from '../command files/handsfree.js'
